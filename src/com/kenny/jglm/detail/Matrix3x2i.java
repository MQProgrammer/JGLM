...
/**
 * 3 columns of 2 components matrix of integer numbers. <br><br>
 * 
 * GLSL type is <code>imat3x2</code>.<br><br>
 *        
 ...
 * @author Kenny
 */
public class Matrix3x2i {

	Vector2i[] value = new Vector2i[3];
	 ...
	 * 
	 * @param other The other {@link Matrix3x2i}.
	 */
	public Matrix3x2i(Matrix3x2i other) {
	 ...
	 */
	public Matrix3x2i(Vector2i v0, Vector2i v1, Vector2i v2) {
		this.value[0] = v0;
		this.value[1] = v1;
		this.value[2] = v2;
	}
	 ...
	 * @param v2 Third row of this matrix.
	 */
	public Matrix3x2i(Vector2d v0, Vector2d v1, Vector2d v2) {
		this.value[0] = new Vector2i(v0.x, v0.y);
		this.value[1] = new Vector2i(v1.x, v1.y);
		this.value[2] = new Vector2i(v2.x, v2.y);
	}
	 ...
	 */
	public Matrix3x2i(Matrix2i m) {
		this.value[0] = m.get(0);
		this.value[1] = m.get(1);
		this.value[2] = new Vector2i(0);
	}
	 ...
	 */
	public Matrix3x2i(Matrix2x3i m) {
	 ...
	 */
	public Matrix3x2i(Matrix2x4i m) {
		this.value[0] = new Vector2i(m.get(0));
		this.value[1] = new Vector2i(m.get(1));
		this.value[2] = new Vector2i(0);
	}
	 ...
	 */
	public Matrix3x2i(Matrix3x4i m) {
		this.value[0] = new Vector2i(m.get(0));
		this.value[1] = new Vector2i(m.get(1));
		this.value[2] = new Vector2i(m.get(2));
	}
	 ...
	 */
	public Matrix3x2i(Matrix4x2i m) {
		this.value[0] = new Vector2i(m.get(0));
		this.value[1] = new Vector2i(m.get(1));
		this.value[2] = new Vector2i(m.get(2));
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix3x2i}.
	 * 
	 * @param other The other {@link Matrix3x2i}.
	 */
	public Matrix3x2i set(Matrix3x2i other) {
		this.value[0] = other.value[0];
		this.value[1] = other.value[1];
		this.value[2] = other.value[2];
		return this;
	 ...
	 */
	public Matrix3x2i add(int scalar) {
	 ...
	 * 
	 * @param m The other {@link Matrix3x2i}.
	 */
	public Matrix3x2i add(Matrix3x2i m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x2i sub(int scalar) {
	 ...
	 * @param m The other {@link Matrix3x2i}.
	 */
	public Matrix3x2i sub(Matrix3x2i m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x2i mul(int scalar) {
	 ...
	 */
	public Matrix2i mul(Matrix3x2i m1, Matrix2x3i m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x2i mul(Matrix3x2i m1, Matrix3i m2) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x2i div(int scalar) {
	 ...
	 */
	public Matrix3x2i inc2() {
		Matrix3x2i Result = new Matrix3x2i(this);
		this.value[0].inc();
		this.value[1].inc();
		this.value[2].inc();
		return Result;
	 ...
	 */
	public Matrix3x2i add(Matrix3x2i m, int scalar) {
		return new Matrix3x2i(m.get(0).add(scalar),
						    m.get(1).add(scalar),
						    m.get(2).add(scalar));
	}
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i add(int scalar, Matrix3x2i m) {
		return new Matrix3x2i(m.get(0).add(scalar),
						    m.get(1).add(scalar),
						    m.get(2).add(scalar));
	}
	...
	/**
	 * Adds the {@link Matrix3x2i} to {@link Matrix3x2i} and return result as new matrix.
	 * 
	 * @param m1 The left {@link Matrix3x2i}.
	 * @param m2 The right {@link Matrix3x2i}.
	 */
	public Matrix3x2i add(Matrix3x2i m1, Matrix3x2i m2) {
		return new Matrix3x2i(m1.get(0).add(m2.get(0)),
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i sub(Matrix3x2i m, int scalar) {
		return new Matrix3x2i(m.get(0).sub(scalar),
						    m.get(1).sub(scalar),
						    m.get(2).sub(scalar));
	}
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i sub(int scalar, Matrix3x2i m) {
		return new Matrix3x2i(Operator.sub(scalar, m.get(0)),
				            Operator.sub(scalar, m.get(1)),
				            Operator.sub(scalar, m.get(2)));
	}
	
	/**
	 * Subtracts the {@link Matrix3x2i} from {@link Matrix3x2i} and return result as new matrix.
	 * 
	 * @param m1 The left {@link Matrix3x2i}.
	 * @param m2 The right {@link Matrix3x2i}.
	 */
	public Matrix3x2i sub(Matrix3x2i m1, Matrix3x2i m2) {
		return new Matrix3x2i(m1.get(0).sub(m2.get(0)),
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i mul(Matrix3x2i m, int scalar) {
		return new Matrix3x2i(m.get(0).mul(scalar),
						    m.get(1).mul(scalar),
						    m.get(2).mul(scalar));
	}
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i mul(int scalar, Matrix3x2i m) {
		return new Matrix3x2i(m.get(0).mul(scalar),
			                m.get(1).mul(scalar),
			                m.get(2).mul(scalar));
	}
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x2i mul(Matrix3x2i m1, Matrix3x2i m2) {
		int SrcA00 = m1.get(0, 0);
		int SrcA01 = m1.get(0, 1);
		...
		Matrix3x2i Result = new Matrix3x2i();
		Result.set(0, 0, SrcA00 * SrcB00 + SrcA10 * SrcB01 + SrcA20 * SrcB02);
		Result.set(0, 1, SrcA01 * SrcB00 + SrcA11 * SrcB01 + SrcA21 * SrcB02);
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4x2i mul(Matrix3x2i m1, Matrix4x3i m2) {
	 ...
	 */
	public Vector3i mulRow(Matrix3x2i m, Vector3i row_v) {
		return new Vector3i(
	 ...
	 */
	public Vector3i mulCol(Vector3i col_v, Matrix3x2i m) {
		return new Vector3i(
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i div(Matrix3x2i m, int scalar) {
		return new Matrix3x2i(m.get(0).div(scalar),
						      m.get(1).div(scalar),
						      m.get(2).div(scalar));
	}
	 ...
	 * @param m The {@link Matrix3x2i}.
	 */
	public Matrix3x2i div(int scalar, Matrix3x2i m) {
		return new Matrix3x2i(Operator.div(scalar, m.get(0)),
	...
	public boolean equals(Matrix3x2i m1, Matrix3x2i m2) {
