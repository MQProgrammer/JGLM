...
/**
 * 4 columns of 3 components matrix of floating-point numbers.<br><br>
 * 
...
public class Matrix4x3f {
	...
	public Matrix4x3f() {
		...
		this.value[3] = new Vector3f(0f, 0f, 0f);
	}
	 ...
	 * 
	 * @param other The other {@link Matrix4x3f}.
	 */
	 ...
	 */
	public Matrix4x3f(float scalar) {
	...
	public Matrix4x3f(
		...
		this.value[0] = new Vector3f(x0, y0, z1);
		this.value[1] = new Vector3f(x1, y1, z1);
		this.value[2] = new Vector3f(x2, y2, z2);
		this.value[3] = new Vector3f(x3, y3, z3);
	}
	 ...
	 */
	public Matrix4x3f(Vector3f v0, Vector3f v1, Vector3f v2, Vector3f v3) {
		this.value[0] = v0;
		this.value[1] = v1;
		this.value[2] = v2;
		this.value[3] = v3;
	 ...
	 */
	public Matrix4x3f(Matrix2f m) {
		this.value[0] = new Vector3f(m.get(0), 0f);
		this.value[1] = new Vector3f(m.get(1), 0f);
		this.value[2] = new Vector3f(0f, 0f, 1f);
		this.value[3] = new Vector3f(0f, 0f, 0f);
	}
	 ...
	 */
	public Matrix4x3f(Matrix2x3f m) {
	 ...
	 */
	public Matrix4x3f(Matrix2x4f m) {
		this.value[0] = new Vector3f(m.get(0));
		this.value[1] = new Vector3f(m.get(1));
		this.value[2] = new Vector3f(0f, 0f, 1f);
		this.value[3] = new Vector3f(0f, 0f, 0f);
	 ...
	 */
	public Matrix4x3f(Matrix3x2f m) {
		this.value[0] = new Vector3f(m.get(0), 0f);
		this.value[1] = new Vector3f(m.get(1), 0f);
		this.value[2] = new Vector3f(m.get(2), 1f);
		this.value[3] = new Vector3f(0f, 0f,   0f);
	}
	 ...
	 */
	public Matrix4x3f(Matrix3x4f m) {
		this.value[0] = new Vector3f(m.get(0));
		this.value[1] = new Vector3f(m.get(1));
		this.value[2] = new Vector3f(m.get(2));
		this.value[3] = new Vector3f(0f, 0f, 0f);
	...
	/**
	 * Sets values from another copy of {@link Matrix4x3f}.
	 * 
	 * @param other The other {@link Matrix4x3f}.
	 */
	 ...
	 */
	public Matrix4x3f add(float scalar) {
	 ...
	 * 
	 * @param m The other {@link Matrix4x3f}.
	 */
	public Matrix4x3f add(Matrix4x3f m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix4x3f sub(float scalar) {
	 ...
	 * @param m The other {@link Matrix4x3f}.
	 */
	public Matrix4x3f sub(Matrix4x3f m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix4x3f mul(float scalar) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix4x3f div(float scalar) {
	 ...
	 */
	public Matrix4x3f inc2() {
		Matrix4x3f Result = new Matrix4x3f(this);
		this.value[0].inc();
		this.value[1].inc();
		this.value[2].inc();
		this.value[3].inc();
	 ...
	 */
	public Matrix4x3f add(Matrix4x3f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f add(float scalar, Matrix4x3f m) {
		return new Matrix4x3f(m.get(0).add(scalar),
						      m.get(1).add(scalar),
						      m.get(2).add(scalar),
						      m.get(3).add(scalar));
	 ...
	 */
	public Matrix4x3f add(Matrix4x3f m1, Matrix4x3f m2) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f sub(Matrix4x3f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f sub(float scalar, Matrix4x3f m) {
	 ...
	 * @param m2 The right {@link Matrix4x3f}.
	 */
	public Matrix4x3f sub(Matrix4x3f m1, Matrix4x3f m2) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f mul(Matrix4x3f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f mul(float scalar, Matrix4x3f m) {
		return new Matrix4x3f(m.get(0).mul(scalar),
			                  m.get(1).mul(scalar),
			                  m.get(2).mul(scalar),
			                  m.get(3).mul(scalar));
	 ...
	 */
	public Matrix2x3f mul(Matrix4x3f m1, Matrix2x4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3f mul(Matrix4x3f m1, Matrix3x4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4x3f mul(Matrix4x3f m1, Matrix4f m2) {
	 ...
	 */
	public Vector3f mulRow(Matrix4x3f m, Vector4f row_v) {
		return new Vector3f(
	 ...
	 */
	public Vector4f mulCol(Vector4f col_v, Matrix4x3f m) {
		return new Vector4f(
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f div(Matrix4x3f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4x3f}.
	 */
	public Matrix4x3f div(float scalar, Matrix4x3f m) {
	...
	public boolean equals(Matrix4x3f m1, Matrix4x3f m2) {
