...
/**
 * 4 columns of 4 components matrix of floating-point numbers. <br><br>
 * 
...
public class Matrix4f {
	 ...
	 * 
	 * @param other The other {@link Matrix4f}.
	 */
	...
	public Matrix4f(float scalar) {
		...
		this.value[3] = new Vector4f(0f, 0f, 0f, scalar);
	}
	...
	public Matrix4f(
		...
		this.value[3] = new Vector4f(x3, y3, z3, w3);
	}
	 ...
	 * @param v4 Four row of this matrix.
	 */
	public Matrix4f(Vector4d v0, Vector4d v1, Vector4d v2, Vector4d v3) {
		this.value[0] = new Vector4f(v0.x, v0.y, v0.z, v0.w);
		this.value[1] = new Vector4f(v1.x, v1.y, v1.z, v1.w);
		this.value[2] = new Vector4f(v2.x, v2.y, v2.z, v2.w);
		this.value[3] = new Vector4f(v3.x, v3.y, v3.z, v3.w);
	}
	...
	public Matrix4f(Matrix3f m) {
		this.value[0] = new Vector4f(m.get(0), 0f);
		this.value[1] = new Vector4f(m.get(1), 0f);
		this.value[2] = new Vector4f(m.get(2), 0f);
		this.value[3] = new Vector4f(0, 0f, 0f,1f);
	}
	 ...
	 */
	public Matrix4f(Matrix3x2f m) {
		this.value[0] = new Vector4f(m.get(0), 0f, 0f);
		this.value[1] = new Vector4f(m.get(1), 0f, 0f);
		this.value[2] = new Vector4f(m.get(2), 1f, 0f);
		this.value[3] = new Vector4f(0f, 0f, 0f,   1f);
	}
	 ...
	 * @param m The {@link Matrix3x4f}.	
	 */
	public Matrix4f(Matrix4x2f m) {
		this.value[0] = new Vector4f(m.get(0), 0f, 0f);
		this.value[1] = new Vector4f(m.get(1), 0f, 0f);
		this.value[2] = new Vector4f(m.get(2), 0f, 0f);
		this.value[3] = new Vector4f(0f, 0f, 0f, 1f);
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix4f}.
	 * 
	 * @param other The other {@link Matrix4f}.
	 */
	 ...
	 * 
	 * @param m The other {@link Matrix4f}.
	 */
	 ...
	 */
	public Matrix4f add(Matrix4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f add(float scalar, Matrix4f m) {
		return new Matrix4f(m.get(0).add(scalar),
						    m.get(1).add(scalar),
						    m.get(2).add(scalar),
						    m.get(3).add(scalar));
	 ...
	 */
	public Matrix4f add(Matrix4f m1, Matrix4f m2) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f sub(Matrix4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f sub(float scalar, Matrix4f m) {
	 ...
	 * @param m2 The right {@link Matrix4f}.
	 */
	public Matrix4f sub(Matrix4f m1, Matrix4f m2) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f mul(Matrix4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f mul(float scalar, Matrix4f m) {
		return new Matrix4f(m.get(0).mul(scalar),
			                m.get(1).mul(scalar),
			                m.get(2).mul(scalar),
			                m.get(3).mul(scalar));
	 ...
	 */
	public Matrix2x4f mul(Matrix4f m1, Matrix2x4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x4f mul(Matrix4f m1, Matrix3x4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4f mul(Matrix4f m1, Matrix4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix2x3f mul(Matrix4f m1, Matrix2x3f m2) {
	 ...
	 */
	public Vector4f mulRow(Matrix4f m, Vector4f row_v) {
		/*
	 ...
	 */
	public Vector4f mulCol(Vector4f col_v, Matrix4f m) {
		return new Vector4f(
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f div(Matrix4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix4f}.
	 */
	public Matrix4f div(float scalar, Matrix4f m) {
	 ...
	 */
	public Matrix4f div(Matrix4f m1, Matrix4f m2) {
	 ...
	 * @return The column vector.
	 */
	public Vector4f divRow(Matrix4f m, Vector4f row_v) {
	 ...
	 * @return The row vector.
	 */
	public Vector4f divCol(Matrix4f m, Vector4f col_v) {
		return mulCol(col_v, FuncMatrix.inverse(m));
	}

	// -- Boolean operators --
	
	public boolean equals(Matrix4f m1, Matrix4f m2) {
