...
/**
 * 3 columns of 4 components matrix of double-precision floating-point numbers. <br><br>
 * 
 * GLSL type is <code>dmat3x4</code>.<br><br>
 *        
 ...
 * @author Kenny
 */
public class Matrix3x4d {

	Vector4d[] value = new Vector4d[3];
	 ...
	 * 
	 * @param other The other {@link Matrix3x4d}.
	 */
	 ...
	 */
	public Matrix3x4d(double scalar) {
	 ...
	 */
	public Matrix3x4d(Vector4d v0, Vector4d v1, Vector4d v2) {
		this.value[0] = v0;
		this.value[1] = v1;
		this.value[2] = v2;
	}
	 ...
	 * @param v2 Third row of this matrix.
	 */
	public Matrix3x4d(Vector4f v0, Vector4f v1, Vector4f v2) {
		this.value[0] = new Vector4d(v0.x, v0.y, v0.z, v0.y);
		this.value[1] = new Vector4d(v1.x, v1.y, v1.z, v1.y);
		this.value[2] = new Vector4d(v2.x, v2.y, v2.z, v2.y);
	}
	 ...
	 */
	public Matrix3x4d(Matrix2x3d m) {
	 ...
	 */
	public Matrix3x4d(Matrix2x4d m) {
	 ...
	 * @param m The {@link Matrix2x4d}.	
	 */
	public Matrix3x4d(Matrix3x2d m) {
		this.value[0] = new Vector4d(m.get(0), 0, 0);
		this.value[1] = new Vector4d(m.get(1), 0, 0);
		this.value[2] = new Vector4d(m.get(2), 1, 0);
	}
	 ...
	 * @param m The {@link Matrix2d}.	
	 */
	public Matrix3x4d(Matrix3d m) {
		this.value[0] = new Vector4d(m.get(0), 0);
		this.value[1] = new Vector4d(m.get(1), 0);
		this.value[2] = new Vector4d(m.get(2), 0);
	}
	 ...
	 */
	public Matrix3x4d(Matrix4x2d m) {
		this.value[0] = new Vector4d(m.get(0), 0, 0);
		this.value[1] = new Vector4d(m.get(1), 0, 0);
		this.value[2] = new Vector4d(m.get(2), 0, 0);
	}
	 ...
	 */
	public Matrix3x4d(Matrix4x3d m) {
		this.value[0] = new Vector4d(m.get(0), 0);
		this.value[1] = new Vector4d(m.get(1), 0);
		this.value[2] = new Vector4d(m.get(2), 0);
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix3x4d}.
	 * 
	 * @param other The other {@link Matrix3x4d}.
	 */
	public Matrix3x4d set(Matrix3x4d other) {
		this.value[0] = other.value[0];
		this.value[1] = other.value[1];
		this.value[2] = other.value[2];
		return this;
	 ...
	 */
	public Matrix3x4d add(double scalar) {
	 ...
	 * 
	 * @param m The other {@link Matrix3x4d}.
	 */
	public Matrix3x4d add(Matrix3x4d m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4d sub(double scalar) {
	 ...
	 * @param m The other {@link Matrix3x4d}.
	 */
	public Matrix3x4d sub(Matrix3x4d m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4d mul(double scalar) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4d div(double scalar) {
	 ...
	 */
	public Matrix3x4d inc2() {
		Matrix3x4d Result = new Matrix3x4d(this);
		this.value[0].inc();
		this.value[1].inc();
		this.value[2].inc();
		return Result;
	 ...
	 */
	public Matrix3x4d add(Matrix3x4d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d add(double scalar, Matrix3x4d m) {
		return new Matrix3x4d(m.get(0).add(scalar),
						      m.get(1).add(scalar),
						      m.get(2).add(scalar));
	}
	 ...
	 */
	public Matrix3x4d add(Matrix3x4d m1, Matrix3x4d m2) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d sub(Matrix3x4d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d sub(double scalar, Matrix3x4d m) {
	 ...
	 * @param m2 The right {@link Matrix3x4d}.
	 */
	public Matrix3x4d sub(Matrix3x4d m1, Matrix3x4d m2) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d mul(Matrix3x4d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d mul(double scalar, Matrix3x4d m) {
		return new Matrix3x4d(m.get(0).mul(scalar),
			                  m.get(1).mul(scalar),
			                  m.get(2).mul(scalar));
	}
	 ...
	 */
	public Matrix2x4d mul(Matrix3x4d m1, Matrix2x3d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x4d mul(Matrix3x4d m1, Matrix3d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x4d mul(Matrix3x4d m1, Matrix3x4d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4d mul(Matrix3x4d m1, Matrix4x3d m2) {
	 ...
	 */
	public Vector4d mulRow(Matrix3x4d m, Vector3d row_v) {
		return new Vector4d(
	 ...
	 */
	public Vector3d mulCol(Vector4d col_v, Matrix3x4d m) {
		return new Vector3d(
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d div(Matrix3x4d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3x4d}.
	 */
	public Matrix3x4d div(double scalar, Matrix3x4d m) {
	...
	public boolean equals(Matrix3x4d m1, Matrix3x4d m2) {
