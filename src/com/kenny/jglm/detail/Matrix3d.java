...
/**
 * 3 columns of 3 components matrix of double-precision floating-point numbers. <br><br>
 * 
 * GLSL type is <code>dmat3 or dmat3x3</code>.<br><br>
 *        
...
public class Matrix3d {
	 ...
	 * 
	 * @param other The other {@link Matrix3d}.
	 */
	 ...
	 * @param v2 Third row of this matrix.
	 */
	public Matrix3d(Vector3f v0, Vector3f v1, Vector3f v2) {
	...
	public Matrix3d(Matrix2d m) {
		...
		this.value[2] = new Vector3d(0, 0, 1);
	}
	...
	public Matrix3d(Matrix3x2d m) {
		this.value[0] = new Vector3d(m.get(0), 0);
		this.value[1] = new Vector3d(m.get(1), 0);
		this.value[2] = new Vector3d(m.get(2), 1);
	}
	 ...
	 */
	public Matrix3d(Matrix4x2d m) {
		this.value[0] = new Vector3d(m.get(0), 0);
		this.value[1] = new Vector3d(m.get(1), 0);
		this.value[2] = new Vector3d(m.get(2), 0);
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix3d}.
	 * 
	 * @param other The other {@link Matrix3d}.
	 */
	 ...
	 * 
	 * @param m The other {@link Matrix3d}.
	 */
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3d sub(double scalar) {
	 ...
	 */
	public Matrix3d add(Matrix3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d add(double scalar, Matrix3d m) {
		return new Matrix3d(m.get(0).add(scalar),
						    m.get(1).add(scalar),
						    m.get(2).add(scalar));
	}
	 ...
	 */
	public Matrix3d add(Matrix3d m1, Matrix3d m2) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d sub(Matrix3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d sub(double scalar, Matrix3d m) {
	 ...
	 * @param m2 The right {@link Matrix3d}.
	 */
	public Matrix3d sub(Matrix3d m1, Matrix3d m2) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d mul(Matrix3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d mul(double scalar, Matrix3d m) {
		return new Matrix3d(m.get(0).mul(scalar),
			                m.get(1).mul(scalar),
			                m.get(2).mul(scalar));
	}
	 ...
	 */
	public Matrix3d mul(Matrix3d m1, Matrix3d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix2x3d mul(Matrix3d m1, Matrix2x3d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4x3d mul(Matrix3d m1, Matrix4x3d m2) {
	 ...
	 */
	public Vector3d mulRow(Matrix3d m, Vector3d row_v) {
		return new Vector3d(
	 ...
	 */
	public Vector3d mulCol(Vector3d col_v, Matrix3d m) {
		return new Vector3d(
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d div(Matrix3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix3d}.
	 */
	public Matrix3d div(double scalar, Matrix3d m) {
	 ...
	 */
	public Matrix3d div(Matrix3d m1, Matrix3d m2) {
	 ...
	 * @return The column vector.
	 */
	public Vector3d divRow(Matrix3d m, Vector3d row_v) {
	 ...
	 * @return The row vector.
	 */
	public Vector3d divCol(Matrix3d m, Vector3d col_v) {
		return mulCol(col_v, FuncMatrix.inverse(m));
	}

	// -- Boolean operators --
	
	public boolean equals(Matrix3d m1, Matrix3d m2) {
