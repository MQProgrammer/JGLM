...
/**
 * 2 columns of 3 components matrix of double-precision floating-point numbers. <br><br>
 * 
 * GLSL type is <code>dmat2x3 </code>.<br><br>
 *        
...
public class Matrix2x3d {
	 ...
	 * 
	 * @param other The other {@link Matrix2x3d}.
	 */
	 ...
	 */
	public Matrix2x3d(double scalar) {
	...
	public Matrix2x3d(
		...
		this.value[0] = new Vector3d(x0, y0, z0);
	 ...
	 */
	public Matrix2x3d(Vector3d v0, Vector3d v1) {
		this.value[0] = v0;
		this.value[1] = v1;
	}
	 ...
	 * @param v1 Second row of this matrix.	
	 */
	public Matrix2x3d(Vector3f v0, Vector3f v1) {
	 ...
	 */
	public Matrix2x3d(Matrix2d m) {
		this.value[0] = new Vector3d(m.get(0), 0d);
		this.value[1] = new Vector3d(m.get(1), 0d);
	}
	 ...
	 */
	public Matrix2x3d(Matrix2x4d m) {
	 ...
	 */
	public Matrix2x3d(Matrix3x4d m) {
		this.value[0] = new Vector3d(m.get(0));
		this.value[1] = new Vector3d(m.get(1));
	}
	 ...
	 */
	public Matrix2x3d(Matrix4x2d m) {
		this.value[0] = new Vector3d(m.get(0), 0);
		this.value[1] = new Vector3d(m.get(1), 0);
	}
	 ...
	 */
	public Matrix2x3d(Matrix4x3d m) {
		this.value[0] = new Vector3d(m.get(0));
		this.value[1] = new Vector3d(m.get(1));
	}
	 ...
	 */
	public Matrix2x3d(Matrix3x2d m) {
		this.value[0] = new Vector3d(m.get(0), 0);
		this.value[1] = new Vector3d(m.get(1), 0);
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix2x3d}.
	 * 
	 * @param other The other {@link Matrix2x3d}.
	 */
	public Matrix2x3d set(Matrix2x3d other) {
		this.value[0] = other.value[0];
		this.value[1] = other.value[1];
		return this;
	}
	 ...
	 */
	public Matrix2x3d add(double scalar) {
	 ...
	 * 
	 * @param m The other {@link Matrix2x3d}.
	 */
	public Matrix2x3d add(Matrix2x3d m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix2x3d sub(double scalar) {
	 ...
	 * @param m The other {@link Matrix2x3d}.
	 */
	public Matrix2x3d sub(Matrix2x3d m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix2x3d mul(double scalar) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix2x3d div(double scalar) {
	 ...
	 */
	public Matrix2x3d inc2() {
		Matrix2x3d Result = new Matrix2x3d(this);
		this.value[0].inc();
		this.value[1].inc();
		return Result;
	}
	 ...
	 */
	public Matrix2x3d add(Matrix2x3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d add(double scalar, Matrix2x3d m) {
		return new Matrix2x3d(m.get(0).add(scalar),
						      m.get(1).add(scalar));
	}
	 ...
	 */
	public Matrix2x3d add(Matrix2x3d m1, Matrix2x3d m2) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d sub(Matrix2x3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d sub(double scalar, Matrix2x3d m) {
	 ...
	 * @param m2 The right {@link Matrix2x3d}.
	 */
	public Matrix2x3d sub(Matrix2x3d m1, Matrix2x3d m2) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d mul(Matrix2x3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d mul(double scalar, Matrix2x3d m) {
		return new Matrix2x3d(m.get(0).mul(scalar),
			                  m.get(1).mul(scalar));
	}
	 ...
	 */
	public Matrix2x3d mul(Matrix2x3d m1, Matrix2d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3d mul(Matrix2x3d m1, Matrix3x2d m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4x3d mul(Matrix2x3d m1, Matrix4x2d m2) {
	 ...
	 */
	public Vector3d mulRow(Matrix2x3d m, Vector2d row_v) {
		return new Vector3d(
	 ...
	 */
	public Vector2d mulCol(Vector3d col_v, Matrix2x3d m) {
		return new Vector2d(
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d div(Matrix2x3d m, double scalar) {
	 ...
	 * @param m The {@link Matrix2x3d}.
	 */
	public Matrix2x3d div(double scalar, Matrix2x3d m) {
	...
	public boolean equals(Matrix2x3d m1, Matrix2x3d m2) {
