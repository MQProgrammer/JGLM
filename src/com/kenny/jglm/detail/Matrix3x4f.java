...
/**
 * 3 columns of 4 components matrix of floating-point numbers.<br><br>
 * 
...
public class Matrix3x4f {
	 ...
	 * 
	 * @param other The other {@link Matrix3x4f}.
	 */
	...
	public Matrix3x4f(
		...
		this.value[2] = new Vector4f(x2, y2, z2, w2);
	}
	 ...
	 */
	public Matrix3x4f(Vector4f v0, Vector4f v1, Vector4f v2) {
		this.value[0] = v0;
		this.value[1] = v1;
		this.value[2] = v2;
	}
	 ...
	 * @param v2 Third row of this matrix.
	 */
	public Matrix3x4f(Vector4d v0, Vector4d v1, Vector4d v2) {
		this.value[0] = new Vector4f(v0.x, v0.y, v0.z, v0.y);
		this.value[1] = new Vector4f(v1.x, v1.y, v1.z, v1.y);
		this.value[2] = new Vector4f(v2.x, v2.y, v2.z, v2.y);
	}
	 ...
	 */
	public Matrix3x4f(Matrix2x3f m) {
	 ...
	 */
	public Matrix3x4f(Matrix2x4f m) {
	 ...
	 * @param m The {@link Matrix2x4f}.	
	 */
	public Matrix3x4f(Matrix3x2f m) {
		this.value[0] = new Vector4f(m.get(0), 0, 0);
		this.value[1] = new Vector4f(m.get(1), 0, 0);
		this.value[2] = new Vector4f(m.get(2), 1, 0);
	}
	 ...
	 * @param m The {@link Matrix2f}.	
	 */
	public Matrix3x4f(Matrix3f m) {
		this.value[0] = new Vector4f(m.get(0), 0);
		this.value[1] = new Vector4f(m.get(1), 0);
		this.value[2] = new Vector4f(m.get(2), 0);
	}
	 ...
	 */
	public Matrix3x4f(Matrix4f m) {
		this.value[0] = new Vector4f(m.get(0));
		this.value[1] = new Vector4f(m.get(1));
		this.value[2] = new Vector4f(m.get(2));
	}
	 ...
	 */
	public Matrix3x4f(Matrix4x2f m) {
		this.value[0] = new Vector4f(m.get(0), 0, 0);
		this.value[1] = new Vector4f(m.get(1), 0, 0);
		this.value[2] = new Vector4f(m.get(2), 0, 0);
	}
	 ...
	 */
	public Matrix3x4f(Matrix4x3f m) {
		this.value[0] = new Vector4f(m.get(0), 0);
		this.value[1] = new Vector4f(m.get(1), 0);
		this.value[2] = new Vector4f(m.get(2), 0);
	}
	...
	/**
	 * Sets values from another copy of {@link Matrix3x4f}.
	 * 
	 * @param other The other {@link Matrix3x4f}.
	 */
	public Matrix3x4f set(Matrix3x4f other) {
		this.value[0] = other.value[0];
		this.value[1] = other.value[1];
		this.value[2] = other.value[2];
		return this;
	 ...
	 */
	public Matrix3x4f add(float scalar) {
	 ...
	 * 
	 * @param m The other {@link Matrix3x4f}.
	 */
	public Matrix3x4f add(Matrix3x4f m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4f sub(float scalar) {
	 ...
	 * @param m The other {@link Matrix3x4f}.
	 */
	public Matrix3x4f sub(Matrix3x4f m) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4f mul(float scalar) {
	 ...
	 * @param scalar The scalar value.
	 */
	public Matrix3x4f div(float scalar) {
	 ...
	 */
	public Matrix3x4f inc2() {
		Matrix3x4f Result = new Matrix3x4f(this);
		this.value[0].inc();
		this.value[1].inc();
		this.value[2].inc();
		return Result;
	 ...
	 */
	public Matrix3x4f add(Matrix3x4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f add(float scalar, Matrix3x4f m) {
		return new Matrix3x4f(m.get(0).add(scalar),
						      m.get(1).add(scalar),
						      m.get(2).add(scalar));
	}
	 ...
	 */
	public Matrix3x4f add(Matrix3x4f m1, Matrix3x4f m2) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f sub(Matrix3x4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f sub(float scalar, Matrix3x4f m) {
	 ...
	 * @param m2 The right {@link Matrix3x4f}.
	 */
	public Matrix3x4f sub(Matrix3x4f m1, Matrix3x4f m2) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f mul(Matrix3x4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f mul(float scalar, Matrix3x4f m) {
		return new Matrix3x4f(m.get(0).mul(scalar),
			                  m.get(1).mul(scalar),
			                  m.get(2).mul(scalar));
	}
	 ...
	 */
	public Matrix2x4f mul(Matrix3x4f m1, Matrix2x3f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x4f mul(Matrix3x4f m1, Matrix3f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix3x4f mul(Matrix3x4f m1, Matrix3x4f m2) {
	 ...
	 * @param m2 Left matrix.
	 */
	public Matrix4f mul(Matrix3x4f m1, Matrix4x3f m2) {
	 ...
	 */
	public Vector4f mulRow(Matrix3x4f m, Vector3f row_v) {
		return new Vector4f(
	 ...
	 */
	public Vector3f mulCol(Vector4f col_v, Matrix3x4f m) {
		return new Vector3f(
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f div(Matrix3x4f m, float scalar) {
	 ...
	 * @param m The {@link Matrix3x4f}.
	 */
	public Matrix3x4f div(float scalar, Matrix3x4f m) {
	...
	public boolean equals(Matrix3x4f m1, Matrix3x4f m2) {
